  ...
  <div class="table-responsive">
      <table class="table table-borderless">
          ...
          <tbody>
                  ...
                  <tr>
                      <td>2</td>
                      <td>Jabón Liquído para manos 2 en 1 Coco & Vainilla Bacterion Doypack 1000 ml</td>
                      <td>Jabón Liquído para manos 2 en 1 Coco & Vainilla Bacterion Doypack 1000 ml</td>
                      <td>13.2</td>
                      <td>Bolivar</td>
                      <td>Jabón Liquido</td>
                  ...
                  <tr>
                      <td>3</td>
                      <td>Jabón Dove Original Sixpack 1000 ml</td>
                      <td>Jabón Dove Original Sixpack 1000 ml</td>
                      <td>15.9</td>
                      <td>Bolivar</td>
                  ...
                  <tr>
                      <td>4</td>
                      <td>Pack x3 Crema Dental Aquafresh Triple Protección 126g</td>
                      <td>Pack x3 Crema Dental Aquafresh Triple Protección 126g</td>
                      <td>12.5</td>
                      <td>Visibush</td>
                      <td>Pastas dentales</td>
                  ...
                  <tr>
                      <td>5</td>
                      <td>Jabón Liquido Doble Humectación Avena y Aceite de almendras Doypack 900 ml</td>
                      <td>Jabón Liquido Doble Humectación Avena y Aceite de almendras Doypack 900 ml</td>
                      <td>10.6</td>
                      <td>Bolivar</td>
                      <td>Jabón Liquido</td>
        ...
        <nav class="mt-2 d-flex justify-content-between align-items-center">
            ...
            <div>
                <ul class="pagination mb-0">
                    <li class="page-item">
                        <a class="page-link" href="productos?pagina=1&cantidad=5&q=">Anterior</a>
                    </li>

                    <li class="page-item">
                        <a class="page-link active" href="productos?pagina=1&cantidad=5&q=">1</a>
                    </li>
                    
                    <li class="page-item">
                        <a class="page-link " href="productos?pagina=1&cantidad=5&q=">2</a>
                    </li>
                    <li class="page-item">
                        <a class="page-link" href="productos?pagina=2&cantidad=5&q=">Siguiente</a>
                    </li>
                </ul>
            </div>
        </nav>
