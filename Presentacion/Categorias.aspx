              ...
              <table class="table table-borderless">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td>Artículos de proteccion contra el COVID-19</td>
                          <td>
                                              ...
                                              <form name="form-data" action="categorias" method="POST" >
                                                  ...
                                                  <div class="modal-body" id="cont_modal">
                                                      ...
                                                      <div>
                                                          ...
                                                          <input type="text" class="form-control" id="editar-descripcion" name="descripcion" placeholder="Agregar descripción" value="Artículos de proteccion contra el COVID-19" placeholder="" required="true">
                                                      </div>
                                                  </div>
                                          ...
                                          <div class="modal-content">
                                              ...
                                              <form name="form-data" action="categorias" method="POST" >
                                                  ...
                                                  <div class="modal-body" id="cont_modal">
                                                      <div class="mb-3">
                                                          <label for="editar-nombre" class="col-form-label">Nombre</label>
                                                          <input type="text" class="form-control" id="editar-nombre" name="nombre" placeholder="Agregar nombre" value="Hogar y cocina" required="true">
                                                      </div>

                                                      <div>
                                                          <label for="editar-descripcion" class="col-form-label">Descripción</label>
                                                          <input type="text" class="form-control" id="editar-descripcion" name="descripcion" placeholder="Agregar descripción" value="Artículos del hogar" placeholder="" required="true">
                                                      </div>
                                                  </div>
...
<!---fin ventana eliminar--->
                      ...
                      <tr>
                          ...
                          <td>Disuelve la suciedad sin corroerlo</td>
                          <td>
                              <div class="d-flex justify-content-center">
                                  <button class="btn btn-secondary me-2" type="button" data-bs-toggle="modal" data-bs-target="#editarCat">
                                      Editar
                                          ...
                                          <div class="modal-content">
                                              ...
                                              <form name="form-data" action="categorias" method="POST" >
                                                  ...
                                                  <div class="modal-body" id="cont_modal">
                                                      <div class="mb-3">
                                                          <label for="editar-nombre" class="col-form-label">Nombre</label>
                                                          <input type="text" class="form-control" id="editar-nombre" name="nombre" placeholder="Agregar nombre" value="Detergente Liquido" required="true">
                                                      </div>

                                                      <div>
                                                          <label for="editar-descripcion" class="col-form-label">Descripción</label>
                                                          <input type="text" class="form-control" id="editar-descripcion" name="descripcion" placeholder="Agregar descripción" value="Disuelve la suciedad sin corroerlo." placeholder="" required="true">
                                                      </div>
                                                  </div>
...
<!---fin ventana eliminar--->
                      ...
                      <tr>
                          <td>4</td>
                          <td>Ambientadores</td>
                          <td>Sustancia para perfumar el ambiente</td>
                          <td>
                              <div class="d-flex justify-content-center">
                                  <button class="btn btn-secondary me-2" type="button" data-bs-toggle="modal" data-bs-target="#editarCat">
                                      Editar
                                          ...
                                          <div class="modal-content">
                                              ...
                                              <form name="form-data" action="categorias" method="POST" >
                                                  ...
                                                  <div class="modal-body" id="cont_modal">
                                                      <div class="mb-3">
                                                          <label for="editar-nombre" class="col-form-label">Nombre</label>
                                                          <input type="text" class="form-control" id="editar-nombre" name="nombre" placeholder="Agregar nombre" value="Ambientadores" required="true">
                                                      </div>

                                                      <div>
                                                          <label for="editar-descripcion" class="col-form-label">Descripción</label>
                                                          <input type="text" class="form-control" id="editar-descripcion" name="descripcion" placeholder="Agregar descripción" value=" Sustancia para perfumar el ambiente" placeholder="" required="true">
                                                      </div>
                                                  </div>
...
<!---fin ventana eliminar--->
                      ...
                      <tr>
                          <td>5</td>
                          <td>Insecticidas</td>
                          <td>Utilizado para matar insectos</td>
                          <td>
                              <div class="d-flex justify-content-center">
                                  <button class="btn btn-secondary me-2" type="button" data-bs-toggle="modal" data-bs-target="#editarCat">
                                      Editar
                                          ...
                                          <div class="modal-content">
                                              ...
                                              <form name="form-data" action="categorias" method="POST" >
                                                  ...
                                                  <div class="modal-body" id="cont_modal">
                                                      <div class="mb-3">
                                                          <label for="editar-nombre" class="col-form-label">Nombre</label>
                                                          <input type="text" class="form-control" id="editar-nombre" name="nombre" placeholder="Agregar nombre" value="Insecticidas" required="true">
                                                      </div>

                                                      <div>
                                                          <label for="editar-descripcion" class="col-form-label">Descripción</label>
                                                          <input type="text" class="form-control" id="editar-descripcion" name="descripcion" placeholder="Agregar descripción" value="Utilizado para matar insectos" placeholder="" required="true">
                                                      </div>
                                                  </div>
